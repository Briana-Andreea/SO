...
Codul pentru monitor_reports.c și modificările din
city_manager.c (remove_district, notify_monitor) au
fost scrise integral de student, cu ajutor pentru
debugging și înțelegerea erorilor de compilare.
